...
Route::middleware('auth')->group(function () {
    ...
    Route::get('dashboard', function () {
        ...
        // Fetch the student records based on the student number
        $studentRecord = StudentRecord::where('student_number', $studentNumber)->first();

        return view('user.dashboard', compact('studentRecord'));
    })->name('dashboard');
